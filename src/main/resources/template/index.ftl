<#include "include/header.ftl"/>
    ...
    <a style="margin-left: 10px;margin-right: 10px; width: 180px" href="http://demo.zrlog.com?ref=index" target="_blank"
       class="btn btn-default btn-cta">
        ...
        马上体验 </a>
    <a style="margin-left: 10px;margin-right: 10px;width: 180px" href="${last.downloadUrl}" class="btn btn-default btn-cta">
        ...
        下载（war） </a>
<a style="margin-left: 10px;margin-right: 10px;width: 180px" href="https://gitee.com/94fzb/zrlog-docker" class="btn btn-default btn-cta">
    Docker 模式</a>
    </div>
<br/>
